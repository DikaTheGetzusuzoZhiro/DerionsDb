...
const payloads = {
    help: () => ({
        embeds: [new EmbedBuilder()
            ...
            .setFooter({ text: 'Tama Ryuichi Community System', iconURL: 'https://cdn-icons-png.flaticon.com/512/3135/3135715.png' })
            .setTimestamp()]
    }),
    status: (client) => ({
        embeds: [new EmbedBuilder()
            ...
            .setFooter({ text: 'Tama Ryuichi Community System' })
            .setTimestamp()]
    }),
    panelspam: () => ({
        embeds: [new EmbedBuilder()
            ...
            .setFooter({ text: 'Created By Tama Ryuichi' })],
        components: [
    ...
    if (message.channel.id === scannerChannelId && message.attachments.size > 0) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setFooter({ text: "Deteksi oleh Tama Ryuichi" })
                .setTimestamp();
        ...
        if (commandName === 'upload') {
            try {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setFooter({ text: `@Tama Ryuichi | ${new Date().toLocaleDateString('id-ID')}` });
    ...
    if (interaction.isButton()) {
        if (interaction.customId === 'spam_set_webhook') {
            ...
            modal.addComponents(
                ...
                new ActionRowBuilder().addComponents(new TextInputBuilder().setCustomId('in_webhook_msg').setLabel('Pesan Spam').setStyle(TextInputStyle.Paragraph).setRequired(true).setValue('WEBHOOK INI TELAH DIHANCURKAN OLEH TAMA RYUICHI ANTI KEYLOGGER!'))
            );
        ...
        if (interaction.customId === 'spam_set_tele') {
            ...
            modal.addComponents(
                ...
                new ActionRowBuilder().addComponents(new TextInputBuilder().setCustomId('in_tele_msg').setLabel('Pesan Spam').setStyle(TextInputStyle.Paragraph).setRequired(true).setValue('BOT INI TELAH DIHANCURKAN OLEH TAMA RYUICHI ANTI KEYLOGGER!'))
            );
            return interaction.showModal(modal);
        }
